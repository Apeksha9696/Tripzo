    ...
    <html>
      <head>
        <style>
          ...
          .btn { display: inline-block; padding: 12px 24px; background-color: #40e4d6ff; color: white; text-decoration: none; border-radius: 6px; font-weight: bold; margin: 20px 0; }
        </style>
      </head>
      <body>
        <div class="container">
